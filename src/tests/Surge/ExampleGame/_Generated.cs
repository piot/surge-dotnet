...
{
        InputPackFetch<Tests.ExampleGame.GameInput>? inputFetcher;
...
public sealed class GeneratedEventProcessor : IEventProcessor
{
    ...
    private Tests.Surge.ExampleGame.IShortEvents target;
    public GeneratedEventProcessor(Tests.Surge.ExampleGame.IShortEvents target)
    {
        this.target = target;
    }

    public Tests.Surge.ExampleGame.IShortEvents Target
    {
        set => target = value;
    }
...
public sealed class AvatarLogicEntity
{
    ...
    public AvatarLogicEntityInternal Internal => internalEntity;
...
public AvatarLogicEntityInternal()
 ...
 internal Tests.ExampleGame.AvatarLogic Current
    ...
    writer.WriteUInt16((ushort)serializeFlags);
        ...
        if ((serializeFlags & TestEnumMask) != 0) writer.WriteUInt8((byte)current.testEnum);
    }
    ...
    public void Serialize(ulong serializeFlags, IBitWriter writer)
    {
       writer.WriteBits((uint)serializeFlags, 10);
        ...
        if ((serializeFlags & TestEnumMask) != 0) writer.WriteBits((uint)current.testEnum, 3);
    }
    ...
    writer.WriteUInt16((ushort)serializeFlags);
        ...
        if ((serializeFlags & TestEnumMask) != 0) writer.WriteUInt8((byte)last.testEnum);
    }
    ...
    public void SerializePrevious(ulong serializeFlags, IBitWriter writer)
    {
       writer.WriteBits((uint)serializeFlags, 10);
        ...
        if ((serializeFlags & TestEnumMask) != 0) writer.WriteBits((uint)last.testEnum, 3);
    }
    ...
    public void DeserializeAll(IOctetReader reader)
    {
        ...
        current.testEnum = (Tests.ExampleGame.TestEnum) reader.ReadUInt8();
    }
    ...
    public void DeserializeAll(IBitReader reader)
    {
        ...
        current.testEnum = (Tests.ExampleGame.TestEnum) reader.ReadBits(3);
    }
    ...
    var serializeFlags = (ulong) reader.ReadUInt16();
        ...
        if ((serializeFlags & TestEnumMask) != 0) current.testEnum = (Tests.ExampleGame.TestEnum) reader.ReadUInt8();
    ...
    public ulong Deserialize(IBitReader reader)
    {
       var serializeFlags = (ulong)reader.ReadBits(10);
        ...
        if ((serializeFlags & TestEnumMask) != 0) current.testEnum = (Tests.ExampleGame.TestEnum) reader.ReadBits(3);
    ...
    public TypeInformation TypeInformation
    {
        get
        {
            return new TypeInformation(new TypeInformationField[]
            {
                ...
                new() { mask = TestEnumMask, name = new (nameof(current.testEnum)), type = typeof(Tests.ExampleGame.TestEnum) },
...
public sealed class FireballLogicEntity
{
    ...
    public FireballLogicEntityInternal Internal => internalEntity;
