...
{
    public static class SnapshotDeltaEntityMasksMerger
    {
        /// <summary>
        ...
        public static SnapshotDeltaEntityMasksUnion Merge(SnapshotDeltaEntityMasks[] containers)
        {
            ...
            var mutableContainer = new SnapshotDeltaEntityMasksMutable(tickIdRange);
...
#endif
                foreach (var entityMaskPair in container.EntityMasks)
                {
