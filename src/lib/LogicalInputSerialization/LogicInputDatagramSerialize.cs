...
namespace Piot.Surge.LogicalInputSerialization
{
    ...
    {
        /// <summary>
        /// Serialize logical input according to https://github.com/piot/surge-dotnet/blob/main/doc/protocol.adoc#predicted-logical-input-datagrams 
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="inputs"></param>
        public static void Serialize(IOctetWriter writer, OrderedDatagramsOut sequenceOut, LogicalInput.LogicalInput[] inputs)
        {
