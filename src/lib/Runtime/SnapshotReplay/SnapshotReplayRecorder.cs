...
{
    public class SnapshotReplayRecorder : IReplayControl
    {
        ...
        readonly IDataSender entityContainer;
        readonly IEventReceiver eventProcessor;
        readonly ILog log;
        readonly IDataReceiver playbackWorld;
        ...
        public SnapshotReplayRecorder(SemanticVersion applicationVersion, IDataSender recordWorld,
            IDataReceiver playbackWorld,
            IEventReceiver eventProcessor, ILog log)
        {
            this.log = log;
        ...
        public void LoadPlaybackFromFile(TimeMs now, string filename)
        {
            ...
            playback = new(playbackWorld, eventProcessor, now, applicationVersion,
