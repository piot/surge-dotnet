...
{
    public class NullEventReceiver : IEventReceiver
    {
    ...
    public sealed class ReplayPlayback
    {
        ...
        readonly IEventReceiver savedEventProcessor;
        ...
        public ReplayPlayback(IDataReceiver world,
            IEventReceiver eventProcessor, TimeMs now,
...
//            runSystems();
        ...
        void ApplyCompleteState(CompleteState completeState)
        {
            ...
            nextExpectedSequenceId =
                CompleteStateBitReader.ReadAndApply(bitReader, world, eventProcessor, log, false);
        ...
        void ApplyDeltaState(DeltaState deltaState, bool useEventsAndNotifyWorldSync)
        {
            ...
            nextExpectedSequenceId = SnapshotDeltaBitReader.ReadAndApply(bitReader, world, eventProcessor,
                nextExpectedSequenceId, isOverlappingAndMerged, log,
